...
public class dequene {
    ...
    public dequene() throws IOException {
    ...
    public void pushQueue(Deque<Integer> queue) throws IOException {
        ...
        System.out.println("Введите карты игрока");
    ...
    public void play() {
        ...
        while (playStatus) {
            if (firstPlayer.isEmpty()) {
                playStatus = false;
                System.out.println("Вторая " + counter);

            } else if (secondPlayer.isEmpty()) {
                playStatus = false;
                System.out.println("Первая " + counter);
            }else if(counter==106)
            {
                playStatus = false;
